...
public class Field {
    ...
    private short options;           // see the options definitions in DashBoardActivity
    private String name;
    private String list;
    ...
    public double getValue()
    {
        ...
        if (DashBoardActivity.milesMode) {
...
//    }
    ...
    boolean isSigned() {
        return (this.options & DashBoardActivity.FIELD_TYPE_MASK) == DashBoardActivity.FIELD_TYPE_SIGNED;
    }

    public boolean isString () {
        return (this.options & DashBoardActivity.FIELD_TYPE_MASK) == DashBoardActivity.FIELD_TYPE_STRING;
    }
