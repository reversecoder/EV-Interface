...
import com.reversecoder.canze.classes.FieldLogger;
        ...
        if(binString.length()>= field.getTo()) {
            ...
            try {
                ...
                if (field.isString()) {
                    ...
                    field.setValue(val);
                    // do field logging
                    if (DashBoardActivity.fieldLogMode)
                    ...
                    //DashBoardActivity.debug("Value of " + field.getHexId() + "." + field.getResponseId() + "." + field.getFrom()+" = "+val);
                    //DashBoardActivity.debug("Fields: onMessageCompleteEvent > "+field.getSID()+" = "+val);
