...
import static com.reversecoder.canze.activity.DashBoardActivity.toast;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // load settings
        SharedPreferences settings = getSharedPreferences(DashBoardActivity.PREFERENCES_FILE, 0);
        ...
        int index = 0;
        if (DashBoardActivity.car == DashBoardActivity.CAR_ZOE_Q210) index = 0;
        else if (DashBoardActivity.car == DashBoardActivity.CAR_ZOE_R240) index = 1;
        else if (DashBoardActivity.car == DashBoardActivity.CAR_ZOE_Q90) index = 2;
        else if (DashBoardActivity.car == DashBoardActivity.CAR_ZOE_R90) index = 3;
        else if (DashBoardActivity.car == DashBoardActivity.CAR_FLUENCE) index = 4;
        else if (DashBoardActivity.car == DashBoardActivity.CAR_KANGOO) index = 5;
        else if (DashBoardActivity.car == DashBoardActivity.CAR_X10) index = 6;
        ...
        index = 0;
        if (DashBoardActivity.toastLevel == Fields.TOAST_NONE) index = 0;
        else if (DashBoardActivity.toastLevel == Fields.TOAST_DEVICE) index = 1;
        else if (DashBoardActivity.toastLevel == Fields.TOAST_ALL) index = 2;
        ...
        safe.setChecked(DashBoardActivity.safeDrivingMode);
        safe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!safe.isChecked()) {
                    ...
                    // set dialog message
                    String yes = DashBoardActivity.getStringSingle(R.string.prompt_YesIKnow);
                    String no = DashBoardActivity.getStringSingle(R.string.prompt_NoSecureWay);
                    ...
                    if (width <= 480) {
                        yes = DashBoardActivity.getStringSingle(R.string.default_Yes);
                        no = DashBoardActivity.getStringSingle(R.string.default_No);
                    }
                    ...
                    // set dialog message
                    alertDialogBuilder
                            .setMessage(DashBoardActivity.getStringSingle(R.string.prompt_WarningDriving))
                            .setCancelable(true)
        ...
        miles.setChecked(DashBoardActivity.milesMode);

        final CheckBox btBackground = (CheckBox) findViewById(R.id.btBackgrounding);
        btBackground.setChecked(DashBoardActivity.bluetoothBackgroundMode);
        btBackground.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btBackground.isChecked()) {
                    // set dialog message
                    String yes = DashBoardActivity.getStringSingle(R.string.prompt_YesIKnow);
                    String no = DashBoardActivity.getStringSingle(R.string.prompt_NoThanks);
                    ...
                    // set dialog message
                    alertDialogBuilder
                            .setMessage(Html.fromHtml(DashBoardActivity.getStringSingle(R.string.prompt_BluetoothOn)))
                            .setCancelable(true)
                            .setPositiveButton(yes, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    // if this button is clicked, close
        ...
        dataExport.setChecked(DashBoardActivity.dataExportMode);
        dataExport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!DashBoardActivity.dataLogger.isExternalStorageWritable()) {
                    final Context context = SettingsActivity.this;
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
                    ...
                    // set dialog message
                    alertDialogBuilder
                            .setMessage(Html.fromHtml(DashBoardActivity.getStringSingle(R.string.prompt_NoSd)))
                            .setCancelable(true)
                    ...
                    // show it
                    alertDialog.show();
                    DashBoardActivity.dataExportMode = false; // due to SDcard not writeable
                }
            }
        });

        final CheckBox debugLog = (CheckBox) findViewById(R.id.debugLogMode);
        debugLog.setChecked(DashBoardActivity.debugLogMode);
        ...
        fieldLog.setChecked(DashBoardActivity.fieldLogMode);
        ...
        /*  ApplicationInfo ai = getPackageManager().getApplicationInfo(getPackageName(), 0);
            ...
            SimpleDateFormat sdf = new SimpleDateFormat(DashBoardActivity.getStringSingle(R.string.format_YMDHM), Locale.getDefault());
            PackageInfo pInfo = getPackageManager().getPackageInfo(getPackageName(), 0);
            tv.setText(DashBoardActivity.getStringSingle(R.string.version) + pInfo.versionName + "  //  " + DashBoardActivity.getStringSingle(R.string.build) + sdf.format(buildDate));
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // clear data file
                settings = getSharedPreferences(DashBoardActivity.DATA_FILE, 0);
                ...
                DashBoardActivity.fields.clearAllFields();
                toast(DashBoardActivity.getStringSingle(R.string.toast_CacheCleared));
            }
        });
    ...
    public void onBackPressed() {
        Toast.makeText(SettingsActivity.this, getString(R.string.toast_PleaseUseTop), Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == DashBoardActivity.REQUEST_ENABLE_BT) {
            fillDeviceList();
        }
    ...
    private void tryTofillDeviceList() {
        ...
        if (bluetoothAdapter == null) {
            DashBoardActivity.toast(R.string.toast_NoBluetooth);
        } else {
            if (!bluetoothAdapter.isEnabled()) {
                // launch the system activity
                Intent enableBtIntent = new Intent(BluetoothAdapter.ACTION_REQUEST_ENABLE);
                startActivityForResult(enableBtIntent, DashBoardActivity.REQUEST_ENABLE_BT);
            }
        }
