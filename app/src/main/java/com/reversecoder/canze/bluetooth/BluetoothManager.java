 ...
 */
package com.reversecoder.canze.bluetooth;
    ...
    public void write(String message) {
        ...
        if(bluetoothSocket.isConnected()) {
            ...
            try {
                ...
                Log.d(DashBoardActivity.TAG, "BT: Error sending > " + e.getMessage());
                //Log.d(DashBoardActivity.TAG, "BT: Error sending > restaring BT");
