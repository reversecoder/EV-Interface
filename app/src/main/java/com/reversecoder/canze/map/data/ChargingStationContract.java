package com.reversecoder.canze.map.data;
...
public class ChargingStationContract {
    ...
    * Play Store.
    */
    public static final String CONTENT_AUTHORITY = "com.reversecoder.canze";
     ...
     *
     *     content://com.reversecoder.obd.reader/station/
     *     [           BASE_CONTENT_URI         ][ PATH_STATION ]
     * and
     *     content://com.reversecoder.obd.reader/connection/
     *     [           BASE_CONTENT_URI         ][ PATH_CONNECTION ]
     *
     * is a valid path for looking at reader data.
     *
     *      content://com.reversecoder.obd.reader/givemeroot/
     *
